...
{
    /// <summary>
    /// <see cref="GenericRepository"/> class where TEntity is Type
    /// </summary>
    /// <typeparam name="TEntity">TEntity</typeparam>
    public class GenericRepository<TEntity> where TEntity : class
    {
        #region Private member variables
        internal Evolent_HealthEntities Context;
        ...
        public GenericRepository(Evolent_HealthEntities context)
        {
        ...
        public virtual IEnumerable<TEntity> GetAll(Func<TEntity, Boolean> where)
        {
            return DbSet.Where(where).ToList();
        }
        ...
        /// <summary>
        /// Execute Stored procedure / Plain SQL Query 
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="sql"></param>
        /// <returns></returns>
        ...
        /// <param name="entity"></param>
        /// <param name="Id"></param>
        public virtual void InsertOrUpdate(TEntity entity, int Id = 0)
        {
            if (Id > 0)
            {
